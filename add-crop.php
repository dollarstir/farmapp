		...
		<div class="col-md-10">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-square-controls">Add Crop</h4>
				...
				<div class="card-content collapse show">
					<div class="card-body">
						...
						<form class="form" id="addcrp">
							<div class="form-body">

								<div class="form-group">
									<label for="donationinput1">Crop Cultivated</label>
									<input type="text" id="donationinput1" class="form-control square" placeholder="Crop Cultivated" name="name">
								</div>

								<div class="form-group">
									<label for="donationinput1">Acreage</label>
									<input type="text" id="donationinput1" class="form-control square" placeholder="Acreage" name="ac">
								</div>

								

								<div class="form-group">
									<label for="donationinput1">Supported By Partner</label>
									<select class="form-control square" name="sp">
                                ...
                                <div class="form-group">
									<label for="donationinput1">Select Farmer</label>
								...
								<div class="form-group">
									<label for="donationinput1">Remarks</label>
									<input type="text" id="donationinput1" class="form-control square" placeholder="" name="remarks">
								</div>
