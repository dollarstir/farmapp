      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Add Farmer's Sales Record</h3>
          </div>
		...
		<div class="col-md-10">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-square-controls">Add Farmer's Sales Record</h4>
				...
				<div class="card-content collapse show">
					<div class="card-body">
						...
						<form class="form" id="addsale">
							<div class="form-body">


                            <div class="form-group">
									<label for="donationinput1">Crop</label>
									<select class="form-control square" name="crop">
                                ...
                                <div class="form-group">
									<label for="donationinput1"> Farmer</label>
									<select class="form-control square" name="fid">
								...
								<div class="form-group">
									<label for="donationinput1">Date of Sales</label>
									<input type="date" id="donationinput1" class="form-control square" placeholder="name" name="dos">
								</div>
								...
								<div class="form-group">
									<label for="donationinput1">Partner</label>
									<input type="text" id="donationinput1" class="form-control square" placeholder="qty (Bags)" name="q1">
									<input type="text" id="donationinput1" class="form-control square" placeholder="Unit Price" name="up1">

								</div>

                                <div class="form-group">
									<label for="donationinput1">Farmgate Buyers</label>
									<input type="text" id="donationinput1" class="form-control square" placeholder="qty (Bags)" name="q2">
									<input type="text" id="donationinput1" class="form-control square" placeholder="Unit Price" name="up2">

								</div>

                                <div class="form-group">
									<label for="donationinput1">Open Market Buyers</label>
									<input type="text" id="donationinput1" class="form-control square" placeholder="qty (Bags)" name="q3">
									<input type="text" id="donationinput1" class="form-control square" placeholder="Unit Price" name="up3">

								</div>

                                <div class="form-group">
									<label for="donationinput1">Other</label>
									<input type="text" id="donationinput1" class="form-control square" placeholder="qty (Bags)" name="q4">
									<input type="text" id="donationinput1" class="form-control square" placeholder="Unit Price" name="up4">
								...
								<div class="form-group">
									<label for="donationinput1">Total bags sold</label>
									<input type="number" id="donationinput1" class="form-control square" placeholder="" name="totalbags">
								</div>
								...
								<div class="form-group">
									<label for="donationinput2">Total amount </label>
									<input type="text" id="donationinput2" class="form-control square" placeholder="" name="totalprice">
								</div>
