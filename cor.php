...
<head>
    ...
    <title>Harvest And Credit Offset Record</title>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Harvest And Credit Offset Record</h3>
          </div>
		...
		<div class="col-md-10">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-square-controls">Add Credit Offset Record</h4>
				...
				<div class="card-content collapse show">
					<div class="card-body">
						...
						<form class="form" id="addcor">
							<div class="form-body">

								<div class="form-group">
									<label for="donationinput1">Crop Session</label>
									<input type="text" id="donationinput1" class="form-control square" placeholder="crop session" name="cs">
								</div>

								<div class="form-group">
									<label for="donationinput1">Crop</label>
									<select class="form-control square" name="cropid">
                                ...
                                <div class="form-group">
									...
									<select class="form-control square" name="farmer">
								...
								<div class="form-group">
									<label for="donationinput1">Quantity of produce  harvested(in bags)</label>
									<input type="text" id="donationinput1" class="form-control square" placeholder="Quantity of produce" name="quant1">
								</div>

								

								<div class="form-group">
									<label for="donationinput1">Quantity of produce  given to  partner or offset credit received (in bags)</label>
									<input type="text" id="donationinput1" class="form-control square" placeholder="Quantity of produce to partner" name="quant2">
								</div>
								

								<div class="form-group">
									<label for="donationinput1">Outstanding credit owed to partner (in bags or GH&#8373;)</label>
									<input type="text" id="donationinput1" class="form-control square" placeholder="Outstanding credit" name="outbalance">
								</div>
