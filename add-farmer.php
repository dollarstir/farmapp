		...
		<div class="col-md-10">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-square-controls">Add Farmer</h4>
				...
				<div class="card-content collapse show">
					<div class="card-body">
						...
						<form class="form" id="addfm">
							<div class="form-body">

								<div class="form-group">
									<label for="donationinput1">First Name</label>
									<input type="text" id="donationinput1" class="form-control square" placeholder="name" name="fname">
								</div>

								<div class="form-group">
									<label for="donationinput1">Middle Name</label>
									<input type="text" id="donationinput1" class="form-control square" placeholder="other name" name="mname">
								</div>

								<div class="form-group">
									<label for="donationinput1">Surname</label>
									<input type="text" id="donationinput1" class="form-control square" placeholder="surname" name="lname">
								</div>

								<div class="form-group">
									<label for="donationinput1">Gender</label>
								...
								<div class="form-group">
									<label for="donationinput1">Contact</label>
									<input type="number" id="donationinput1" class="form-control square" placeholder="" name="contact">
								</div>

								<div class="form-group">
									<label for="donationinput1">Registration No</label>
									...
									<input type="text" id="donationinput1" class="form-control square" placeholder="regno" name="regno" value="<?php  echo $fin;?>" readonly>
								</div>


								<div class="form-group">
									<label for="donationinput1">Age</label>
									<select class="form-control square" name="age">
  										<option value="">Age range</option>
										  <option value="Below-20yrs">Below-20yrs</option>
										  <option value="21-30">21-30</option>
										  <option value="31-40">31-40</option>
										  <option value="41-50">41-50</option>
										  <option value="Above-50yrs">Above-50yrs</option>
									</select>
								</div>

								<div class="form-group">
									<label for="donationinput1">Education level</label>
									<select class="form-control square" name="edulevel">
								...
								<div class="form-group">
									<label for="donationinput1">Marital Status</label>
									<select class="form-control square" name="mstatus">
								...
								<div class="form-group">
									<label for="donationinput2">Household Size</label>
									<input type="text" id="donationinput2" class="form-control square" placeholder="" name="hsize">
								</div>

								

								<div class="form-group">
									<label for="donationinput1">District</label>
									<select class="form-control square" name="district">
  										<option value="">Select District</option>
										  <option value="Daffiama Bussie Issa">Daffiama Bussie Issa</option>
										  <option value="Jirapa/Lambussie">Jirapa/Lambussie</option>
										  <option value="Lambussie Karni">Lambussie Karni</option>
										  <option value="Lawra">Lawra</option>
										  <option value="Nadowli">Nadowli</option>
								...
								<div class="form-group">
									<label for="donationinput1">Community</label>
									<select class="form-control square" name="community">
								...
								<div class="form-group">
									<label for="donationinput2">Name of FBO/Association</label>
									<input type="text" id="donationinput2" class="form-control square" placeholder="" name="fbo">
								</div>


								<div class="form-group">
									<label for="donationinput2">Passport Photo</label>
									<input type="file" id="donationinput2" class="form-control square"  name="image">
								</div>
