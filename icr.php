...
<head>
    ...
    <title>Farmers Input Credit Records</title>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Farmers Input Credit Records</h3>
          </div>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form action="#" class="vertical-tab-steps frmicr" id="frmrisk">

                            <!-- Step 1 -->
                            <h6>Step 1</h6>
                            <fieldset>
                                <center><u><h4>Ploughing</h4></u></center>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="location3">Payment System </label>
                                            <select class="custom-select form-control"  id="location3" name="ps">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="location3">Farmer </label>
                                            <select class="custom-select form-control"  id="location3" name="fid">
                                                <option value="">Select Payment System</option>
                                                <?php popfarmer();?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="location3">Crop </label>
                                            <select class="custom-select form-control"  id="location3" name="cropid">
                                                <option value="">Select Payment System</option>
                                                <?php popcrop();?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Quantity</label>
                                            <input type="text" name="quant" class="form-control" id="emailAddress7">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Unit</label>
                                            <input type="text" name="unit" class="form-control" id="emailAddress7">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Total Cost</label>
                                            <input type="text" name="totalcost" class="form-control" id="emailAddress7">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <h6>Step 2</h6>
                            <fieldset>
                                <center><u><h4>Harrowing</h4></u></center>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="location3">Payment System </label>
                                            <select class="custom-select form-control"  id="location3" name="ps2">
                                                <option value="">Select Payment System</option>
                                                <option value="Cash">Cash</option>
                                                <option value="Credit">Credit</option>
                                                <option value="Produce">Produce</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Quantity</label>
                                            <input type="text" name="quant2" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Unit</label>
                                            <input type="text" name="unit2" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Total Cost</label>
                                            <input type="text" name="totalcost2" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                </div>
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="location3">Payment System </label>
                                            <select class="custom-select form-control"  id="location3" name="ps3">
                                                <option value="">Select Payment System</option>
                                                <option value="Cash">Cash</option>
                                                <option value="Credit">Credit</option>
                                                <option value="Produce">Produce</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Quantity</label>
                                            <input type="text" name="quant3" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Unit</label>
                                            <input type="text" name="unit3" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Total Cost</label>
                                            <input type="text" name="totalcost3" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                </div>
                            ...
                            <h6>Step 4</h6>
                            <fieldset>
                                <center><u><h4>Weedicides</h4></u></center>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="location3">Payment System </label>
                                            <select class="custom-select form-control"  id="location3" name="ps4">
                                                <option value="">Select Payment System</option>
                                                <option value="Cash">Cash</option>
                                                <option value="Credit">Credit</option>
                                                <option value="Produce">Produce</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Quantity</label>
                                            <input type="text" name="quant4" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Unit</label>
                                            <input type="text" name="unit4" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Total Cost</label>
                                            <input type="text" name="totalcost4" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                </div>
                            ...
                            <h6>Step 5</h6>
                            <fieldset>
                                <center><u><h4>Fertilizer Type</h4></u></center>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="location3">Payment System </label>
                                            <select class="custom-select form-control"  id="location3" name="ps5">
                                                <option value="">Select Payment System</option>
                                                <option value="Cash">Cash</option>
                                                <option value="Credit">Credit</option>
                                                <option value="Produce">Produce</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Quantity</label>
                                            <input type="text" name="quant5" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Unit</label>
                                            <input type="text" name="unit5" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Total Cost</label>
                                            <input type="text" name="totalcost5" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                </div>
                            ...
                            <h6>Step 6</h6>
                            <fieldset>
                                <center><u><h4>Harvesting</h4></u></center>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="location3">Payment System </label>
                                            <select class="custom-select form-control"  id="location3" name="ps6">
                                                <option value="">Select Payment System</option>
                                                <option value="Cash">Cash</option>
                                                <option value="Credit">Credit</option>
                                                <option value="Produce">Produce</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Quantity</label>
                                            <input type="text" name="quant6" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Unit</label>
                                            <input type="text" name="unit6" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Total Cost</label>
                                            <input type="text" name="totalcost6" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                </div>
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="location3">Payment System </label>
                                            <select class="custom-select form-control"  id="location3" name="ps7">
                                                <option value="">Select Payment System</option>
                                                <option value="Cash">Cash</option>
                                                <option value="Credit">Credit</option>
                                                <option value="Produce">Produce</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Quantity</label>
                                            <input type="text" name="quant7" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Unit</label>
                                            <input type="text" name="unit7" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Total Cost</label>
                                            <input type="text" name="totalcost7" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                </div>
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="location3">Payment System </label>
                                            <select class="custom-select form-control"  id="location3" name="ps8">
                                                <option value="">Select Payment System</option>
                                                <option value="Cash">Cash</option>
                                                <option value="Credit">Credit</option>
                                                <option value="Produce">Produce</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Quantity</label>
                                            <input type="text" name="quant8" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Unit</label>
                                            <input type="text" name="unit8" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="emailAddress7">Total Cost</label>
                                            <input type="text" name="totalcost8" class="form-control" id="emailAddress7" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="date4">Date</label>
                                            <input type="date" name="dr8" class="form-control" id="date4" >
                                        </div>
                                    </div>
                                </div>
